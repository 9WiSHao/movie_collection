...
const { userId, username, avatarUrl, email, password } = useUserStore()
...
function handleEdit() {
    ...
    editRef.value?.validate(async (valid: boolean) => {
        if (valid) {
            const uname = editForm.username === '' ? username : editForm.username
            const pwd = editForm.password === '' ? password : editForm.password
...
// 存储图片预览
const avatarPreview = ref(avatarUrl)
    ...
    <div class="user-info">
        ...
        <div class="edit">
            ...
            <div class="avatar-edit">
                <img :src="avatarPreview || avatarUrl" class="avatar-preview">
            ...
            <el-form :rules="editRules" ref="editRef" :model="editForm" label-position="left">
                <el-form-item prop="username" label="修改用户名:">
                    <el-input v-model="editForm.username" placeholder="如果不输入就是不修改"></el-input>
                </el-form-item>
